test_that("ECV_SS Works", {
  ...
  ## First with no names
  expect_equal(ECV_SS(Lambda), ECV_SS_Expected, tolerance = .00001)
  ...
  expect_equal(ECV_SS(Lambda2), ECV_SS_Expected2, tolerance = .00001)
...
test_that("ECV_SG Works", {
  ...
  ## First with no names
  expect_equal(ECV_SG(Lambda), ECV_SG_Expected, tolerance = .00001)
  colnames(Lambda) = c("A", "B", "C", "D")
...
test_that("ECV_GS Works", {
  ...
  ## First with no names
  expect_equal(ECV_GS(Lambda), ECV_GS_Expected, tolerance = .00001)
  colnames(Lambda) = c("A", "B", "C", "D")
...
test_that("IECV Works", {
  ...
  IECV_Expected <- c(0.9853458, 0.8287671, 0.8590502, 0.7411945, 0.3403559,
                       ...
                       0.8858474, 0.3497110)
  ## First with no names
  expect_equal(IECV(Lambda), IECV_Expected, tolerance = .00001)
...
test_that("Omega_S Works", {
  ...
  ## First with no names
  expect_equal(Omega_S(Lambda, Theta), Omega_S_Expected, tolerance = .00001)
  colnames(Lambda) = c("A", "B", "C", "D")
  ...
  expect_equal(Omega_S(Lambda2, Theta2), Omega_S_Expected2,  tolerance = .00001)
...
test_that("Omega_H Works", {
  ...
  ## First with no names
  expect_equal(Omega_H(Lambda, Theta), Omega_H_Expected, tolerance = .00001)
  ...
  expect_equal(Omega_H(Lambda2, Theta2), Omega_H_Expected2,  tolerance = .00001)
...
test_that("PUC Works", {
  Lambda <- matrix(c(  0, .82, .10,   0,
                     ...
                     .75, .55,   0,   0),
                   ncol = 4, byrow = TRUE)
  expect_equal(PUC(Lambda), .7272727272727, tolerance = .00001)
...
test_that("ARPB Works", {
  ...
  expect_equal(ARPB(Lambda, UniLambda), ARPB_Expected, tolerance = .00001)
...
test_that("FD Works", {
  ...
  ## First with no names
  expect_equal(FD(Lambda, Phi), FD_Expected, tolerance = .00001)
  colnames(Lambda) = c("A", "B", "C", "D")
  ...
  expect_equal(FD(Lambda2, Phi2), FD_Expected_2, tolerance = .00001)
...
test_that("H Works", {
  ...
  ## First with no names
  expect_equal(H(Lambda), H_Expected, tolerance = .00001)
  colnames(Lambda) = c("A", "B", "C", "D")
  ...
  expect_equal(H(Lambda2), H_Expected_2, tolerance = .00001)
...
test_that("bifactorIndices Works", {
  ...
  Lambda <- matrix(c(  0, .82, .10,   0,
                   ...
                   ncol = 4, byrow = TRUE)
  UniLambda <- c(.78, .84, .82, .77, .69, .62, .69, .66, .82, .56, .74, .65)
  expect_equal(bifactorIndices(Lambda, UniLambda = UniLambda), readRDS("bindices_from_matrix.rds"), tolerance = .00001)
  ...
  expect_equal(bifactorIndices(Lambda2, Phi = Phi2), readRDS("Lambda2_indices.rds"),  tolerance = .00001)
...
test_that("bifactorIndicesMplus Works", {
  ...
  expect_equal(bifactorIndicesMplus(cont_output, standardized = FALSE), readRDS("cont_unst.rds"), tolerance = .00001)
  expect_equal(bifactorIndicesMplus(cat_output), readRDS("cat_stdyx.rds"), tolerance = .00001)
...
test_that("bifactorIndicesMplus_ESEM Works", {
  ...
  expect_equal(bifactorIndicesMplus_ESEM(std_output), readRDS("ESEM.rds"), tolerance = .00001)
